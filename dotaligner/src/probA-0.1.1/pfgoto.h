...
extern aligm copy_aligm(aligm alig);
extern void free_align(aligm alig);
extern void free_aligm(aligm alig);
...
extern aligm add_sequences(sequ *os, aligm a);
extern aligm trace_back(matrix m, sequ *os, iseq *is, u_sc smat);
