/*
		 ...
		 c  Ivo L Hofacker and Walter Fontana
			  Vienna RNA package
*/
/* Last changed Time-stamp: <2001-11-30 10:33:10 ulim> */
...
/*  static char rcsid[] = "$Id: utils.c,v 1.2 2001/11/30 10:13:51 ulim Exp $"; */
...
PUBLIC char *gett_line(FILE *fp) /* reads lines of arbitrary length from fp */
{
   char s[512], *line, *cp;
   ...
   do {
      ...
      if (cp != NULL) *cp = '\0';
      if (line==NULL)
	 line = (char *) space((strlen(s)+1)*sizeof(char));
      else
