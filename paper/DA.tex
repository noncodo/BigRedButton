...
]{\inits{XQ}\fnm{Xiu Cheng} \snm{Quek}}
\author[
   addressref={aff1,aff2},
...
Source code, pipelines, scripts and data are accessible through the BigRedButton GitHub repository \cite{dotaligner} under an open-source GNU General Public License (GPL).
...
\textit{Additional\_file\_1.pdf }--- Supplementary methods describing the \dotaligner{} implementation in detail, RNA structure clustering, and eCLIP data processing methodologies. \\

\textit{Additional\_file\_2.pdf }--- Supplementary tables and figures with descriptions. \\
