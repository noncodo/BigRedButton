...
sequences of interest.  Our approach outperforms other tools at classifying known RNA structure families, both in time and accuracy. It identifies clusters of known and novel structure motifs from ENCODE immuno-precipitation data of 44 RNA-binding proteins. 
\end{abstract}
...
(Fig. 2B). The SCI represents the alignment consensus energy normali\textsl{•}ed
