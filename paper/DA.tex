...
\title{Identification and clustering of RNA structure motifs}
...
\textcolor{blue}{
\dotaligner's capacity to produce competitive pairwise alignments is
illustrated through the 5S-adenosyl methionine (SAM) riboswitch (Rfam family
RF00634) (Additional file 2: Figure S4). 
In the Rfam alignment the two representative sequences AM420293\_1 and CP000580\_2\_6 have a sequence identity (PID) of 55\%. 
The global pairwise sequence alignment has PID=69\% but fails to align many structural features. 
...
The dot plots in Additional file 2: Figure S4 show how the number of correctly aligned suboptimal base pairs increases through sampling (here 1000 samples and sampling diversity of 0.25). 
However, the example also shows that the alignment scores do not differ very much between \dotaligner's optimal string alignment (step 1) and the best sample (step 2) (0.58 and 0.60 respectively), 
