...
However, the number of correctly aligned suboptimal base pairs increases via \dotaligner{}'s sampling (Additional file 2: Figure S2). In this example, the alignment scores do not differ very much between \dotaligner's optimal string alignment (step 1) and the best sample (step 2): 0.58 and 0.60, respectively. However, the sampling (s=1000 in this example) increased the runtime ~25x, from 0.03 to 0.84 seconds. 
Consequently, \\ 
}
...
shifts the median pairwise sequence identity from 59\% to 72\% (Additional File2: Figure S4). 
...
RNA structures and their homologs throughout the genome (Additional file 2: Figure S7A-C), which can be used to assign putative functions to non-coding loci and categorize them accordingly. }\\
