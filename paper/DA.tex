...
From 2,750 high-confidence ($>$8-fold  fold-enrichment versus background, P-value $<10^{-4}$) eCLIP peaks 
...
\begin{figure}[h!]
 ...
 in each cluster is displayed next to significant clusters; those with an asterisk and portrayed below.
